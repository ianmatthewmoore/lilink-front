        ...
        <div className="py-5">
            ...
            <div className="">
                <div className="card-user-info">
                    ...
                    <div className="col-9">
                        <div className="">
                            <p className="welcome-text-desc-gig-title">Welcome, Seller</p>
                        ...
                        <div className="red-order-bar-bpx">
                            <p className="description-inside-bar-order">Active Order - 2 ($1,300)</p>
                        </div>
                        {
                            user.type && user.type=="COSULTANT"  ? 
                            <div className="">
                            {oders?.map(x=>{
                                return(
                                    ...
                                    <p className="text-desc-gig-active-order-title">Status</p>
                                        <p className="text-desc-gig-active-order-des-card-red">In progress</p>
                                    </div>
                                    <div className="width-text-desc-gig-active">
